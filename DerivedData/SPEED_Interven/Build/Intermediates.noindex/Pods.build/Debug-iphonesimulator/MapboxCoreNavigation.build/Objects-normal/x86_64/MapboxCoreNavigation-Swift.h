...
///
- (nonnull instancetype)initWithRoute:(MBRoute * _Nonnull)route directions:(MBDirections * _Nonnull)directions locationManager:(MBNavigationLocationManager * _Nonnull)locationManager eventsManager:(MMEEventsManager * _Nonnull)eventsManager OBJC_DESIGNATED_INITIALIZER;
