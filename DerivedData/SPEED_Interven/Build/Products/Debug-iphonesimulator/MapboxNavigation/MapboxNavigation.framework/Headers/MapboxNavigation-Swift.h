...
@property (nonatomic, strong) MBVisualInstructionBanner * _Nullable visualInstruction;
- (void)drawRect:(CGRect)rect;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
- (nonnull instancetype)initWithRoute:(MBRoute * _Nonnull)route directions:(MBDirections * _Nonnull)directions styles:(NSArray<MBStyle *> * _Nullable)styles locationManager:(MBNavigationLocationManager * _Nullable)locationManager OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
@interface MBNavigationViewController (SWIFT_EXTENSION(MapboxNavigation)) <MGLMapViewDelegate, MBNavigationMapViewDelegate>
- (MGLStyleLayer * _Nullable)navigationMapView:(MBNavigationMapView * _Nonnull)mapView routeCasingStyleLayerWithIdentifier:(NSString * _Nonnull)identifier source:(MGLSource * _Nonnull)source SWIFT_WARN_UNUSED_RESULT;
- (MGLStyleLayer * _Nullable)navigationMapView:(MBNavigationMapView * _Nonnull)mapView routeStyleLayerWithIdentifier:(NSString * _Nonnull)identifier source:(MGLSource * _Nonnull)source SWIFT_WARN_UNUSED_RESULT;
- (void)navigationMapView:(MBNavigationMapView * _Nonnull)mapView didSelectRoute:(MBRoute * _Nonnull)route;
- (MGLShape * _Nullable)navigationMapView:(MBNavigationMapView * _Nonnull)mapView shapeForRoutes:(NSArray<MBRoute *> * _Nonnull)routes SWIFT_WARN_UNUSED_RESULT;
...
///
/// \param uuid The feedback event’s unique identifier.
///
/// \param feedbackType The type of feedback event that was sent.
///
- (void)navigationViewController:(MBNavigationViewController * _Nonnull)viewController didSendFeedbackAssignedUUID:(NSUUID * _Nonnull)uuid feedbackType:(enum MBFeedbackType)feedbackType;
