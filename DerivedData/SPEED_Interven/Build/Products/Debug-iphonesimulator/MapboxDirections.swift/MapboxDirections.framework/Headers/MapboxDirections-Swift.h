...
@property (nonatomic, readonly, copy) NSArray<MBVisualInstructionComponent *> * _Nonnull textComponents;
...
- (nonnull instancetype)initWithText:(NSString * _Nullable)text maneuverType:(enum MBManeuverType)maneuverType maneuverDirection:(enum MBManeuverDirection)maneuverDirection textComponents:(NSArray<MBVisualInstructionComponent *> * _Nonnull)textComponents degrees:(CLLocationDegrees)degrees OBJC_DESIGNATED_INITIALIZER;
...
///
- (nonnull instancetype)initWithDistanceAlongStep:(CLLocationDistance)distanceAlongStep primaryInstruction:(MBVisualInstruction * _Nonnull)primaryInstruction secondaryInstruction:(MBVisualInstruction * _Nullable)secondaryInstruction drivingSide:(enum MBDrivingSide)drivingSide OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL supportsSecureCoding;)
+ (BOOL)supportsSecureCoding SWIFT_WARN_UNUSED_RESULT;
+ (void)setSupportsSecureCoding:(BOOL)value;
